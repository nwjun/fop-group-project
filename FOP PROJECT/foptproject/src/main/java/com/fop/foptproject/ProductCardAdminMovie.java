...
//        return card;
    ...
    private ScrollPane makeMovieDescription(String movieId, double length) throws ParseException{
        ...
        hall.setStyle("-fx-text-fill:#FFFFFF;-fx-padding:0px 0 5 18px;-fx-font-size:15px");
        ...
        time.setStyle("-fx-text-fill:#FFFFFF;-fx-padding:0px 0 5 18px;-fx-font-size:15px");
